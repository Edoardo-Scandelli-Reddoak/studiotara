    ...
    <>
      ...
      <main className="flex flex-col items-center overflow-x-hidden max-w-[1440px] mx-auto w-full px-4 md:px-10 lg:px-[50px]">
        ...
        <section className="relative w-full rounded-[16px] md:rounded-[24px] lg:rounded-[28px] bg-gradient-to-b from-blue-primary to-blue-secondary overflow-hidden md:min-h-[380px] lg:min-h-[430px]">
          ...
          <div className="hidden md:block absolute md:-left-[8%] md:bottom-[50px] md:w-[360px] md:h-[360px] lg:w-[400px] lg:h-[400px] -rotate-[25deg]">
            <Image
          ...
          {/* Text */}
          <div className="relative z-10 px-5 pt-7 pb-[100px] md:absolute md:left-[320px] md:px-0 md:py-0 lg:left-[500px] md:top-1/2 md:-translate-y-1/2 md:w-[380px] lg:w-[580px]">
        ...
        <section
          id="valutazione"
          className="relative w-full max-w-[860px] mt-5 md:mt-[24px] z-10 bg-white border-[3px] md:border-[8px] lg:border-[10px] border-blue-accent rounded-[12px] md:rounded-[14px] lg:rounded-[16px] shadow-[0px_0px_10.8px_0px_rgba(0,0,0,0.25)] px-4 md:px-12 lg:px-16 py-5 md:py-8 mx-auto scroll-mt-[80px]"
        >
          {/* Mobile characters - lives inside the white form, extends up into the hero (form's z-10 stacks them over the blue) */}
          <div className="md:hidden absolute right-0 -top-[120px] w-[180px] h-[260px] pointer-events-none">
            <Image
              src="/images/personaggi_vendi_immobile.png"
              alt=""
              fill
        ...
        <section className="w-full mt-[64px] md:mt-[120px] lg:mt-[160px] flex flex-col lg:flex-row gap-8 md:gap-10 lg:gap-[81px] items-start">
          {/* Left text */}
          <div className="flex flex-col gap-5 md:gap-6 lg:gap-[34px] lg:w-[645px] shrink-0">
          ...
          {/* Right stats + CTA */}
          <div className="flex flex-col gap-5 md:gap-6 lg:gap-8 items-center w-full lg:w-auto">
            <div className="grid grid-cols-2 gap-3 md:gap-5 lg:gap-[22px] w-full lg:w-[552px]">
              {stats.map((stat, i) => (
                <div
                  key={i}
                  className="bg-gradient-to-b from-blue-primary to-blue-secondary rounded-[10px] md:rounded-[16px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] p-4 md:p-5 lg:p-[23px] min-h-[100px] md:min-h-[110px] lg:min-h-[136px]"
                >
                  <p className="text-[22px] md:text-[28px] lg:text-[32px] font-bold text-white leading-none">
                    {stat.value}
                    <span className="text-red-primary">+</span>
                  </p>
                  <p className="text-[12px] md:text-[14px] lg:text-[16px] text-white tracking-[-0.3px] md:tracking-[-0.5px] lg:tracking-[-0.96px] mt-2 md:mt-3 leading-snug">
                    {stat.label}
                  </p>
                </div>
              ))}
            ...
            <Link
              href="#valutazione"
              className="block w-full text-center md:inline-block md:w-auto bg-red-primary text-white text-[15px] md:text-[17px] font-medium px-6 md:px-10 py-3 md:py-[11px] rounded-[8px] md:rounded-[6px] md:hover:scale-105 md:hover:shadow-lg md:transition-all md:duration-300 active:scale-[0.99]"
            >
        ...
        <section className="w-full mt-[64px] md:mt-[120px] lg:mt-[160px] bg-[#f5f3f0] rounded-[16px] md:rounded-[24px] lg:rounded-[28px] shadow-[0px_2px_8px_0px_rgba(0,0,0,0.15)] md:shadow-[0px_0px_10px_0px_rgba(0,0,0,0.25)] px-5 md:px-10 lg:px-[84px] py-9 md:py-14 lg:py-[78px]">
          <div className="text-center">
            ...
            <p className="text-[14px] md:text-[16px] text-black mt-3 max-w-[688px] mx-auto leading-relaxed">
          ...
          {/* Steps */}
          <div className="relative mt-8 md:mt-14 lg:mt-[90px]">
            {/* Connecting line - desktop only */}
            <div className="hidden lg:block absolute top-[50px] left-[50px] right-[50px] h-[3px] bg-blue-primary/30 rounded-full" />

            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-7 md:gap-8 lg:gap-[47px]">
              {steps.map((step) => (
                <div key={step.num} className="flex flex-col items-center text-center gap-4 md:gap-5 lg:gap-6">
                  {/* Number circle */}
                  <div className="relative z-10 w-[64px] md:w-[85px] lg:w-[100px] h-[64px] md:h-[85px] lg:h-[100px] rounded-full bg-gradient-to-b from-blue-primary to-blue-secondary flex items-center justify-center shadow-md">
                    <span className="text-[24px] md:text-[34px] lg:text-[40px] font-bold text-white">
                      {step.num}
                    </span>
                  </div>
                  <div className="flex flex-col gap-2">
                    <p className="text-[16px] md:text-[18px] font-semibold text-black leading-tight">
                      {step.title}
                    </p>
        ...
        <section className="w-full mt-[64px] md:mt-[120px] lg:mt-[160px]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 lg:gap-10 mt-8 md:mt-12">
            {cards.map((card, i) => (
              <div
                key={i}
                className="bg-gradient-to-b from-blue-primary to-blue-secondary rounded-[14px] md:rounded-[18px] lg:rounded-[20px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] p-5 md:p-7 lg:p-[29px] min-h-[260px] md:min-h-[370px] lg:min-h-[405px] flex flex-col md:hover:-translate-y-1 md:hover:shadow-[0px_8px_30px_0px_rgba(9,45,116,0.3)] md:transition-all md:duration-300"
              >
                ...
                <h3 className="text-[18px] md:text-[22px] lg:text-[24px] font-medium text-white tracking-[-0.6px] md:tracking-[-0.8px] lg:tracking-[-1.2px] mt-4 md:mt-5 lg:mt-6 leading-tight">
                  {card.title}
                </h3>
          ...
          <div className="flex justify-center mt-7 md:mt-10">
            <Link
              href="/contatti"
              className="block w-full max-w-xs mx-auto md:inline-block md:max-w-none md:w-auto text-center bg-red-primary text-white text-[15px] md:text-[17px] font-medium px-6 md:px-10 py-3 md:py-[11px] rounded-[8px] md:rounded-[6px] md:hover:scale-105 md:hover:shadow-lg md:transition-all md:duration-300 active:scale-[0.99]"
            >
