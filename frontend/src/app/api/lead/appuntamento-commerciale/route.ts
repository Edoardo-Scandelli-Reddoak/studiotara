...
// Pipeline & stage for "SITO - appuntamento commerciale"
const PIPELINE_ID = "8b575f78-3a4b-48de-8e19-a83bccfb6fca";
const STAGE_ID = "48cf10d3-7473-4797-a1a2-a08cba30c506";
const SOURCE_ID = 1;
...
export async function POST(req: Request) {
  ...
  if (!contactRes.ok) {
    ...
    console.error("CRM contact create failed (appuntamento-commerciale):", contactRes.status, errText);
    return NextResponse.json(
  ...
  if (!dealRes.ok) {
    ...
    console.error("CRM deal create failed (appuntamento-commerciale):", dealRes.status, errText);
    return NextResponse.json(
