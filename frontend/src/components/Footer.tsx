...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-b from-blue-primary to-blue-secondary text-white">
      <div className="max-w-[1440px] mx-auto px-5 md:px-10 lg:px-[50px] py-10 md:py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10">
          ...
          <div className="flex flex-col gap-4">
            <Image
              ...
              width={150}
              height={32}
              className="brightness-0 invert w-[120px] md:w-[150px]"
            />
            <p className="text-[13px] md:text-[14px] leading-relaxed text-white/75 max-w-[320px]">
          ...
          <div className="flex flex-col gap-3">
            <h3 className="text-[15px] md:text-[16px] font-bold tracking-[-0.6px]">
              Navigazione
            </h3>
            <nav className="flex flex-col gap-2">
              {footerLinks.map((link) => (
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-[13px] md:text-[14px] text-white/75 hover:text-white hover:translate-x-1 transition-all duration-200"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex flex-col gap-2 text-[13px] md:text-[14px] text-white/75">
              <p>Via Roma 2, 20090 Buccinasco (MI)</p>
              <p>Tel: 02 457 0000</p>
        ...
        <div className="mt-8 md:mt-10 pt-5 md:pt-6 border-t border-white/20 flex flex-col md:flex-row justify-between items-center gap-3">
          ...
          <div className="flex gap-5 text-[12px] md:text-[13px] text-white/50">
